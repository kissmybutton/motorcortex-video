...
import DC from '../../DescriptiveIncidents/DescriptiveClip';
import DI from '../../DescriptiveIncidents/DescriptiveIncident';
import { API, loadPlugin } from '../../main';
// STATES LOADING
import { descriptiveTree as descriptiveTree1, lanes as lanes1, realTree as realTree1 } from './states/state1';
import { descriptiveTree as descriptiveTree2, lanes as lanes2, realTree as realTree2 } from './states/state2';
import { descriptiveTree as descriptiveTree3, lanes as lanes3, realTree as realTree3 } from './states/state3';
import { descriptiveTree as descriptiveTree4, lanes as lanes4, realTree as realTree4 } from './states/state4';
import { descriptiveTree as descriptiveTree5, lanes as lanes5, realTree as realTree5 } from './states/state5';
import { descriptiveTree as descriptiveTree6, lanes as lanes6, realTree as realTree6 } from './states/state6';
import { descriptiveTree as descriptiveTree7, lanes as lanes7, realTree as realTree7 } from './states/state7';
...
class MyPluginIncident2 extends API.MonoIncident {
  onGetContext() {
    // console.log('got context');
  }
...
test(`check fragmented clips scratch values on combo attributes are dynamically recalculated
  ...
  const myCASIincidentsById =
    myCASI.realClip.instantiatedChannels['@kissmybutton/test-plugin'].LanesHandler.incidentsById;
