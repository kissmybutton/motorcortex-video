...
class SandboxCollection {
  ...
  _hasOwnProperty(key) {
    return (
      Object.prototype.hasOwnProperty.call(this.originalArray, key) ||
  ...
  _get(key) {
    ...
    this.extraArray[key] = { ...this.originalArray[key] };
    return this.extraArray[key];
  }
  ...
  _keys() {
    const allKeys = Object.keys(this.originalArray).concat(this.addedKeys);
  ...
  _export() {
    for (const key in this.extraArray) {
...
export default SandboxCollection;
