...
import ElementClipSplitter from '../Splitters/ElementClipSplitter';
import ElementSplitter from '../Splitters/ElementSplitter';
...
function incidentFromDescription(descriptiveIncident, contextData, audio = false) {
  ...
  if (Object.prototype.hasOwnProperty.call(descriptiveIncident.props, 'selector')) {
    if (
      ...
      (!!audio && descriptiveIncident.props.selector.charAt(0) !== '~' && !descriptiveIncident.constructor.isClip)
    ) {
      return null;
    }
  }
  ...
  if (descriptiveIncident.constructor.isClip) {
    if (Object.prototype.hasOwnProperty.call(descriptiveIncident.props, 'selector') && !audio) {
