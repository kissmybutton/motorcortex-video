...
import helper, { getAnId } from '../_coreUtils/Helper';
...
*/
import setBlock from './decorators/block';
import unblock from './decorators/unblock';
...
class MonoIncident {
  ...
  setInitialValue(value, storePure = true) {
    ...
    if (typeof this.targetValue === 'object') {
