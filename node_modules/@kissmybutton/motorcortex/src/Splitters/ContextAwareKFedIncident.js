import CAI from './ContextAwareIncident';

class ContextAwareKeyframedIncident extends CAI {
  ...
  get animatedAttributeValue() {
    return this.constructionIngredients.attrs.animatedAttrs[this.attribute][
      this.constructionIngredients.attrs.animatedAttrs[this.attribute].length - 1
    ].value;
  }
}

export default ContextAwareKeyframedIncident;
