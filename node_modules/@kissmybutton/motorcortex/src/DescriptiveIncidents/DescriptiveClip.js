...
import Clip from '../Clip/DOMClip';
import FragmentedClip from '../Clip/FragmentedClip';
import NullClip from '../Clip/NullClip';
import Playable from '../Clip/Playable';
import ClipClone from '../Clip/RootClipClone';
...
class DescriptiveClip extends Playable {
  constructor(attrs, props = null) {
    ...
    this.propsValidationRules = clipPropsRule;
    ...
    if (
      Object.prototype.hasOwnProperty.call(propsToUse, 'selector') &&
    ...
    } else if (this.audio === 'only' && this.props.root !== true) {
    ...
    if (this.audio === 'on' || this.audio === 'only') {
      const audioIngredients = {
        ...
        attrs: {},
        props: {
          audioSources: Object.prototype.hasOwnProperty.call(propsToUse, 'audioSources')
  ...
  // a static member to help incidentFromDefinition identify clips
  ...
  _validateProps() {
    return helper.validateProps({ props: this.props }, clipPropsRule, this.constructor);
  }
...
export default DescriptiveClip;
