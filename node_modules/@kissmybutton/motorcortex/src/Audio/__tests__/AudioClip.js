...
const ReadAudioClip = require('../AudioClip');
...
const AudioClip2 = new MC.AudioClip({
    audioSources: [{
...
const PlaybackHello = new MC.AudioPlayback({}, {
    selector: '~#hello',
    duration: 6000,
    startFrom: 1200,
    id: 'playback-hello'
...
test(`expect AudioClips to contain only audioClip and no real Tree`, () => {
    expect(AudioClip.realClip).toBeInstanceOf(NullClip);
    expect(AudioClip2.realClip).toBeInstanceOf(NullClip);
});

test(`expect a DescriptiveClip with audio false not to have an audioClip`, () => {
    expect(MutedClip.audioClip).toBeInstanceOf(NullClip);
});

test(`expect a DescriptiveClip with audio on to have an audioClip`, () => {
...
test(`Add AudioClip to another AudioClip`, () => {
    ...
    expect(AudioClip.audioClip.instantiatedChannels['@kissmybutton/self-contained-incidents'].incidents).toEqual([{ id: 'audioClip2', millisecond: 0 }]);
...
test(`move an AudioClip`, () => {
    ...
    expect(res.result).toBe(true);
    expect(AudioClip.audioClip.instantiatedChannels['@kissmybutton/self-contained-incidents'].incidents).toEqual([{ id: 'audioClip2', millisecond: 1000 }]);
...
test(`adding an AudioPlayback by id selector should add one MediaPlayback Incident to channels`, () => {
    ...
    expect(AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback'].incidents).toEqual([{ id: 'playback-hello_hello', millisecond: 1000 }]);
    expect(AudioClip2.duration).toBe(7000);
    expect(MutedClip.duration).toBe(7000);
    // console.log(AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback'].incidents);
});
...
test(`moving an AudioPlayback should reflect properly in channels`, () => {
    ...
    expect(res.result).toBe(true);
    expect(AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback']).toBeInstanceOf(AudioPlaybackChannel);
    expect(AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback'].incidents).toEqual([{ id: 'playback-hello_hello', millisecond: 2000 }]);
...
test(`test execution (start / stop) of AudioPlayback Incident`, () => {
    ...
    expect(AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback']
        .incidentsById['playback-hello_hello']
        .contexts['audioClip2']
        .audioNode
        .exportLog()).toEqual([{ event: 'start', ms: 1.300 }, { event: 'stop' }]);
...
test(`make sure that AudioPlaybacks are not executed on seek`, () => {
    AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback']
        .incidentsById['playback-hello_hello']
        .contexts['audioClip2']
        .audioNode
        .clearLog();
...
test(`expect the audioClip and audio playback to execute properly after journey`, () => {
    ...
    expect(AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback']
        ...
        .contexts['audioClip2']
        .audioNode
        .exportLog()).toEqual([{ event: 'start', ms: 1.300 }]);
    expect(AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback']
        .playingIncidentsIds).toEqual(['playback-hello_hello|||audioClip2']);
});
...
test(`expect AudioPlayback to stop when seek starts`, () => {
    ...
    expect(AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback']
        ...
        .contexts['audioClip2']
        .audioNode
        .status).toEqual('stopped');
    expect(AudioClip2.audioClip.instantiatedChannels['@kissmybutton/media-playback']
        .playingIncidentsIds).toEqual([]);
    journey.destination(1800);
});
