...
test('Export definition', () => {
  ...
  /** ******************************************************************* */
  class MyHelpPluginIncident extends API.MonoIncident {
    onGetContext() {
  ...
  expect(exported.incidents.newMPClip.leaf.incidents.newSubMPInc.leaf.plugin_npm_name).toBe(
    '@kissmybutton/test-plugin'
  );
