import { selfContainedContextHandler } from '../_configuration/generalConf';
import ExtendableClip from './ExtendableClip';
// context handlers
import IframeContextHandler from './helpers/IframeContextHandler';
import WebComponentContextHandler from './helpers/WebComponentContextHandler';
...
class Clip extends ExtendableClip {
  ...
  constructor(props = {}, oldProps = null) {
    ...
    const clipType = selfContainedContextHandler;
    ...
    this.ownContext = {
      ...
      isHostedClip: this.isHostedClip,
    };
