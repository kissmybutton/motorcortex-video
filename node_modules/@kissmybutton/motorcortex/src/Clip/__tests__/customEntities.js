...
/** ************************* PLUGIN DEFINITION ************************ */
/** ******************************************************************* */
class MyPluginClip extends API.DOMClip {
  onAfterRender() {
    this.setCustomEntity('myEntity', { alpha: 1, beta: 2 }, ['class1', 'class2']);
    this.setCustomEntity('myEntity', { alpha: 1, beta: 2 }, ['class1', 'class2']);
    this.setCustomEntity('myEntity2', { alpha: 2, beta: 3 }, ['class1', 'class2']);
  }
}
