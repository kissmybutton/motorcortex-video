...
import helper, { isObject, renderTemplate } from '../../_coreUtils/Helper';
...
class IframeContextHandler extends ContextHandler {
  ...
  constructor(props = {}) {
    ...
    iframeDocument.write(renderTemplate(props.html, { params: props.initParams }));
    const bodyFixCSS = `
        body{
            padding:0;
            margin:0;
    ...
    if (styleTag.styleSheet) {
      styleTag.styleSheet.cssText = renderTemplate(props.css, { params: props.initParams }) + bodyFixCSS;
    } else {
