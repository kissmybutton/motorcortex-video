...
function loadPlugin(plugin) {
  ...
  if (!checkPlugin(plugin)) {
    ...
    if (Object.prototype.hasOwnProperty.call(plugin, "Clip")) {
      ...
      }(DescriptiveClip), _defineProperty(_class, "Incident", plugin.Clip), _defineProperty(_class, "audio", plugin.audio ? "only" : "off"), _defineProperty(_class, "customClip", true), _temp);
