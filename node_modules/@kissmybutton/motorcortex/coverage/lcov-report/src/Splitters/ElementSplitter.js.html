...
<html lang="en">
<head>
    <title>Code coverage report for src/Splitters/ElementSplitter.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/Splitters</a> ElementSplitter.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            copiesElements[contextKey] = Array.from(this.instantiatedCopiesContexts[contextKey].rootElement.querySelectorAll(descriptiveIncident.props.selector));</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                this._setElementMCID(this.instantiatedCopiesContexts[contextKey],</span>
...
&nbsp;
    _getElementMCID(element) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!mcid) {
<span class="cstat-no" title="statement not covered" >            mcid = helper.getAnId(true);</span>
<span class="cstat-no" title="statement not covered" >            this.originalContext.setMCID(element, mcid);</span>
        }
        return mcid;
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    _s</span>etElementMCID(context, element, mcid) {
        let existingMCID = <span class="cstat-no" title="statement not covered" >context.getMCID(element);</span>
<span class="cstat-no" title="statement not covered" >        if (!existingMCID) {</span>
<span class="cstat-no" title="statement not covered" >            context.setMCID(element, mcid);</span>
        }
    }
&nbsp;
&nbsp;
    _createElementIncident(element, descriptiveIncident, contextData, elementIndex, totalElements, mcid) {
        ...
        */
        <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.prototype.hasOwnProperty.call(descriptiveIncident.attrs, 'animatedAttrs')) {
        ...
        else <span class="cstat-no" title="statement not covered" >if (Object.prototype.hasOwnProperty.call(descriptiveIncident.attrs, 'keyframes')) {</span>
            // TODO create a keyframes attribute splitter
        }
        else {
            const attrsToPass = <span class="cstat-no" title="statement not covered" >descriptiveIncident.attrs;</span>
            const propsToPass = <span class="cstat-no" title="statement not covered" >{ ...descriptiveIncident.props, selector: this.selector };</span>
            const constructionIngredients = <span class="cstat-no" title="statement not covered" >{</span>
            ...
            const contextAwareIncident = <span class="cstat-no" title="statement not covered" >new ContextAwareIncident(constructionIngredients, contextData, mcid, null);</span>
<span class="cstat-no" title="statement not covered" >            this.addChild(contextAwareIncident, 0);</span>
        }
    }
&nbsp;
}
