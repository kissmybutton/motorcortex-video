...
<html lang="en">
<head>
    <title>Code coverage report for src/_Channels/_Attribute/AttributeChannel.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/_Channels/_Attribute</a> AttributeChannel.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">94.8% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>164/173</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>153/162</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L535'></a><a href='#L535'>535</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">16x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1709x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
            ...
            for (let k = 0; k &lt; lane.length; k++) {
                if (lane[k].id === incidents[i].id) {
                    affectedLanes.push(laneAttrs);
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (fullChannelResize === false) {
                        let affectedAnim = lane[k];
                        let testLaneElement = LanesHandlerSandbox.getLaneElementsClone(affectedAnim);
...
&nbsp;
     ...
     * @param {string} contextId - the contextId of the Incidents to slip
     */
    slipToLaneBackwards(lane, laneData, currentMillisecond, millisecond, contextId, forceReset = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
        ...
        let participatingAnims = _filter(lane, laneItem =&gt; {
            ...
            return (
                (laneItemEnd &lt;= millisecond &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >laneItemEnd &gt;= currentMillisecond)</span> || // they end in the hot area
                (laneItem.millisecond &gt;= currentMillisecond &amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >                    laneItem.millisecond &lt;= millisecond)</span> || // they start in the hot area
                (laneItem.millisecond &lt; currentMillisecond &amp;&amp; laneItemEnd &gt; millisecond)
            ); // they overlap the hot area
        });
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (participatingAnims.length == 0) {
