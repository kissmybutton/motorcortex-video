...
<html lang="en">
<head>
    <title>Code coverage report for src/_Channels/_Attribute/LanesHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/_Channels/_Attribute</a> LanesHandler.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">95.38% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>186/195</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">83.7% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>77/92</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">95.11% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>175/184</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L487'></a><a href='#L487'>487</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">16x</span>
...
&nbsp;
        ...
        if (newAnimsIndex === 0) { // if the newly entered animation is the first of the lane
            if (theLane.length &gt; 1) { // and it has other animations too
                <span class="missing-if-branch" title="else path not taken" >E</span>if (this.incidentsById._get(theLane[1].id).hasInitialValue()) { // if the initial value of the following animation
...
&nbsp;
        ...
        if (Object.prototype.hasOwnProperty.call(this.comboAttributes, attr)) {
            const incidentInitialValues = incident.getInitialValue();
...
&nbsp;
        ...
        if (newAnimsIndex + 1 &lt; theLane.length) {
            onSuccessAction = function () {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (that.incidentsById._get(theLane[newAnimsIndex + 1].id).gotContext) {
                ...
                if (animationIndexBeforeEdit !== animationIndexAfterEdit || animationIndexAfterEdit &gt; 1) {
                    if (animationIndexBeforeEdit + 1 &lt; lane.length) { // if the animation was not the last animation on the lane before the edit
                        ...
                        if (animationIndexBeforeEdit === 0) { // if the edited animation was the first one before the edit
                            ...
                            <span class="missing-if-branch" title="else path not taken" >E</span>if (animation.hasInitialValue() !== false) {
                                // get the initial value of the edited animation and set it as initial value of the new 0 index
                                if (isComboAttr) {
                                    setInitialValueForCombo(lane, this.incidentsById, animation.getInitialValue(), 0);
                                }
                                else {
                                    this.incidentsById._get(laneBeforeEdit[1].id).setInitialValue(animation.getInitialValue());
...
<span class="cstat-no" title="statement not covered" >                                if (isComboAttr) {</span>
<span class="cstat-no" title="statement not covered" >                                    setInitialValueForCombo(lane, this.incidentsById, this.incidentsById._get(laneBeforeEdit[1].id).getScratchValue(), 0);</span>
                                }
                                else {
<span class="cstat-no" title="statement not covered" >                                    this.incidentsById._get(laneBeforeEdit[1].id).setInitialValue(this.incidentsById._get(laneBeforeEdit[1].id).getScratchValue());</span>
<span class="cstat-no" title="statement not covered" >                                    this.incidentsById._get(laneBeforeEdit[1].id).onGetContext();</span>
                                }
                            }
                        }
                            ...
                            if (isComboAttr) {
                                const indexToAffect = animationIndexAfterEdit &gt; animationIndexBeforeEdit ? animationIndexBeforeEdit : <span class="branch-1 cbranch-no" title="branch not covered" >animationIndexAfterEdit;</span>
                                setInitialValueForCombo(lane, this.incidentsById, this.incidentsById._get(laneBeforeEdit[animationIndexBeforeEdit - 1].id).animatedAttributeValue, indexToAffect);
                            }
                            else {
...
&nbsp;
                    ...
                    if (animationIndexAfterEdit === 0) { // is it the first one (after edit)?
                        ...
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.incidentsById._get(laneBeforeEdit[0].id).hasInitialValue()) {
                            // get the initial values of the previously 0 indexed animation of the lane
                            if (isComboAttr) {
                                setInitialValueForCombo(lane, this.incidentsById, this.incidentsById._get(laneBeforeEdit[0].id).getInitialValue(), animationIndexAfterEdit);
                            }
                            else {
                                animation.setInitialValue(this.incidentsById._get(laneBeforeEdit[0].id).getInitialValue());
                                animation.onGetContext();
                            }
                        }
                        else { // otherwise calculate the initial value on the fly, our of the dom
<span class="cstat-no" title="statement not covered" >                            if (isComboAttr) {</span>
<span class="cstat-no" title="statement not covered" >                                setInitialValueForCombo(lane, this.incidentsById, animation.getScratchValue(), animationIndexAfterEdit);</span>
                            }
                            else {
<span class="cstat-no" title="statement not covered" >                                animation.setInitialValue(animation.getScratchValue());</span>
<span class="cstat-no" title="statement not covered" >                                animation.onGetContext();</span>
                            }
                        }
                    }
                        ...
                        if (isComboAttr) {
                            setInitialValueForCombo(lane, this.incidentsById, this.incidentsById._get(lane[animationIndexAfterEdit - 1].id).animatedAttributeValue, animationIndexAfterEdit);
                        }
                        else {
...
&nbsp;
                    ...
                    if (animationIndexAfterEdit + 1 &lt; lane.length) {
                        ...
                        if (isComboAttr) {
                            setInitialValueForCombo(lane, this.incidentsById, animation.animatedAttributeValue, animationIndexAfterEdit + 1);
                        }
                        else {
...
&nbsp;
                if (lane.length === 0) {
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.prototype.hasOwnProperty.call(affectedLanes, belongingLanes[j])) {
