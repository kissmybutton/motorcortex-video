...
<html lang="en">
<head>
    <title>Code coverage report for src/_Channels/_Clip/ClipsChannel.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/_Channels/_Clip</a> ClipsChannel.js
    </h1>
    <div class='clearfix'>
...
<a name='L231'></a><a href='#L231'>231</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">13x</span>
...
&nbsp;
        for (let i = 0; i &lt; incidents.length; i++) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.prototype.hasOwnProperty.call(this.incidentsById, incidents[i].id)) {
...
&nbsp;
        ...
        const exec = function () {
            ...
            for (let i = 0; i &lt; incidents.length; i++) {
                that._incidentById(incidents[i].id)._onGetContextOnce();
            }
        }
&nbsp;
...
&nbsp;
                ...
                else <span class="missing-if-branch" title="if path not taken" >I</span>if (to &gt; laneItem.millisecond + incident.duration) {
<span class="cstat-no" title="statement not covered" >                    incident.onProgress(1, incident.duration, contextId, true);</span>
            ...
            const that = this;
            let participatingItems = _filter(this.incidents, laneItem =&gt; {
                return (
...
&nbsp;
                const fraction = overcameEnd ? <span class="branch-0 cbranch-no" title="branch not covered" >1 </span>: (to - laneItem.millisecond) / contextAwareClipIncident.duration;
                const millisecond = overcameEnd ? <span class="branch-0 cbranch-no" title="branch not covered" >contextAwareClipIncident.duration </span>: to - laneItem.millisecond;
&nbsp;
