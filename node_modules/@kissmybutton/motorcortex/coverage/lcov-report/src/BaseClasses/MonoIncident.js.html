...
<html lang="en">
<head>
    <title>Code coverage report for src/BaseClasses/MonoIncident.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/BaseClasses</a> MonoIncident.js
    </h1>
    <div class='clearfix'>
...
<a name='L224'></a><a href='#L224'>224</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
*/
class MonoIncident {
    constructor(attrs = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> props = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> dna) {
        // super(props);
        this.attrs = attrs;
        this.props = props;
        this.dna = dna;
&nbsp;
        ...
        this.mcid = dna.mcid;
&nbsp;
        this.id = props.id || <span class="branch-1 cbranch-no" title="branch not covered" >helper.getAnId();</span>
...
&nbsp;
        ...
        */
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.prototype.hasOwnProperty.call(props, "plugin_channel_class")) {
<span class="cstat-no" title="statement not covered" >            this.plugin_channel_class = props.plugin_channel_class;</span>
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.prototype.hasOwnProperty.call(props, "mc_plugin_npm_name")) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    se</span>t animAttributes(value) {
<span class="cstat-no" title="statement not covered" >        this.attrs.animatedAttrs[this.attributeKey] = value;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    */
<span class="fstat-no" title="function not covered" >    ge</span>tScratchValue() {
<span class="cstat-no" title="statement not covered" >        return 0;</span>
    }
&nbsp;
    get element() {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.contex === null) {
<span class="cstat-no" title="statement not covered" >            return [];</span>
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.context.getElementByMCID) {
            return this.context.getElementByMCID(this.mcid);
        }
<span class="cstat-no" title="statement not covered" >        return this.context.getElements(this.selector)[0];</span>
    }
&nbsp;
    get attributeKey() {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    ge</span>tElementAttribute(attr) {
<span class="cstat-no" title="statement not covered" >        return this.element.getAttribute(attr);</span>
    }
&nbsp;
...
&nbsp;
    setInitialValue(value, storePure = <span class="branch-0 cbranch-no" title="branch not covered" >true)</span> {
        if (storePure === true) {
...
&nbsp;
        if (typeof this.targetValue === "object") { // if it is a combo attribute
            for (let key in this.userDefinedInitialValues[this.attributeKey]) {
...
&nbsp;
    _onGetContextOnce() {
        ...
        try {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (this.context.fragment === true) {
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.gotContext) {
                this.onGetContext();
