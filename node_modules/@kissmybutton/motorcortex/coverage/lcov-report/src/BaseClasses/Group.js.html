...
<html lang="en">
<head>
    <title>Code coverage report for src/BaseClasses/Group.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/BaseClasses</a> Group.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Node = require('../Tree/Node');
...
&nbsp;
    handleAddIncident(target, payload) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.id === target) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (theIncident === null) {
...
&nbsp;
    handleMoveIncident(target, payload) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.id === target) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (res === null) {
<span class="cstat-no" title="statement not covered" >                return this.bypass();</span>
            }
            return res;
        }
...
&nbsp;
<span class="fstat-no" title="function not covered" >    @h</span>andleResize
    handleResize() {}
&nbsp;
    removeChild(id) {
