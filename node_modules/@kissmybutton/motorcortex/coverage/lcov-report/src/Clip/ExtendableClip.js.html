...
<html lang="en">
<head>
    <title>Code coverage report for src/Clip/ExtendableClip.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/Clip</a> ExtendableClip.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">60.87% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>126/207</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">60.1% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>116/193</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L654'></a><a href='#L654'>654</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Helper = require('../_coreUtils/Helper');
...
&nbsp;
<span class="fstat-no" title="function not covered" >    co</span>ntextLoading() {
<span class="cstat-no" title="statement not covered" >        this.contextReady = false;</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    co</span>ntextLoaded() {
<span class="cstat-no" title="statement not covered" >        this.contextReady = true;</span>
...
&nbsp;
     ...
     **/
<span class="fstat-no" title="function not covered" >    ad</span>dContext(contextData) {
<span class="cstat-no" title="statement not covered" >        this.instantiatedCopiesContexts[contextData.clipId] = contextData.context;</span>
<span class="cstat-no" title="statement not covered" >        contextData.instantiatedCopiesContexts = this.instantiatedCopiesContexts;</span>
        const res = <span class="cstat-no" title="statement not covered" >this.putMessageOnPipe('addContext', contextData, {}, { selfExecute: false, direction: _TREECONST._DIRECTIONS._DOWN });</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (Object.keys(this.instantiatedCopiesContexts).length === 1) { // if it is the first one to be added</span>
<span class="cstat-no" title="statement not covered" >            for (let key in this.instantiatedChannels) {</span>
<span class="cstat-no" title="statement not covered" >                this.instantiatedChannels[key].recalcScratchValues(contextData.clipId);</span>
            }
...
<span class="cstat-no" title="statement not covered" >            this.context.nonFragmentedContext = contextData.context;</span>
        }
&nbsp;
...
&nbsp;
    ...
    purposes
    */
<span class="fstat-no" title="function not covered" >    ex</span>portConstructionArguments() {
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    _r</span>esize(durationFraction) {
<span class="cstat-no" title="statement not covered" >        for (let key in this.instantiatedChannels) {</span>
<span class="cstat-no" title="statement not covered" >            this.instantiatedChannels[key]._resize(durationFraction);</span>
        }
<span class="cstat-no" title="statement not covered" >        this.setNewDuration(this.duration * durationFraction);</span>
<span class="cstat-no" title="statement not covered" >        for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; this.durationSubs.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >            this.durationSubs[i](this.duration);</span>
        }
    }
&nbsp;
    /*********************************************************
...
&nbsp;
        ...
        for (let i = 0; i &lt; candidates.length; i++) {
            ...
            for (let pluginName in incidentsByPlugin) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!Object.prototype.hasOwnProperty.call(totalIncidentsByPlugin, pluginName)) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (res.result === true) {
...
<span class="cstat-no" title="statement not covered" >                        candidates[i].responder.putMessageOnPipe('addContext', {</span>
                                clipId: contextKey,
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (pluginResult.result === false) {
<span class="cstat-no" title="statement not covered" >                toReturnErrors = toReturnErrors.concat(pluginResult.errors);</span>
            }
            else {
...
&nbsp;
     ...
     * }
     */
<span class="fstat-no" title="function not covered" >    re</span>sizeIncident(payload) {
        const candidates = <span class="cstat-no" title="statement not covered" >this.putMessageOnPipe('resize', {</span>
                incidentId: payload.id,
...
&nbsp;
        const totalIncidentsByPlugin = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >        for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; candidates.length; i++) {</span>
            const incidentsByPlugin = <span class="cstat-no" title="statement not covered" >candidates[i].response.getIncidentsByChannel(candidates[i].positionDelta);</span>
<span class="cstat-no" title="statement not covered" >            for (let pluginName in incidentsByPlugin) {</span>
<span class="cstat-no" title="statement not covered" >                if (!Object.prototype.hasOwnProperty.call(totalIncidentsByPlugin, pluginName)) {</span>
<span class="cstat-no" title="statement not covered" >                    totalIncidentsByPlugin[pluginName] = [];</span>
                }
<span class="cstat-no" title="statement not covered" >                totalIncidentsByPlugin[pluginName].push(...incidentsByPlugin[pluginName]);</span>
            }
        }
&nbsp;
        let positionDelta = <span class="cstat-no" title="statement not covered" >0;</span>
<span class="cstat-no" title="statement not covered" >        if (candidates.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >            positionDelta = candidates[0].positionDelta;</span>
        }
        const res = <span class="cstat-no" title="statement not covered" >this.checkResize(payload.fraction, totalIncidentsByPlugin, positionDelta);</span>
<span class="cstat-no" title="statement not covered" >        if (res.result === true) {</span>
            const successCallback = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >()</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >                res.execute();</span>
<span class="cstat-no" title="statement not covered" >                for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; candidates.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                    candidates[i].responder.setNewDuration(payload.newSize);</span>
                }
            }
<span class="cstat-no" title="statement not covered" >            return {</span>
                result: true,
...
&nbsp;
     ...
     **/
<span class="fstat-no" title="function not covered" >    ch</span>eckResize(durationFraction, incidentsById, adjustMillisecond = <span class="branch-0 cbranch-no" title="branch not covered" >0)</span> {
        // prepare the return payload
        let toReturnResult = <span class="cstat-no" title="statement not covered" >true;</span>
        let toReturnErrors = <span class="cstat-no" title="statement not covered" >[];</span>
        let toReturnExecutables = <span class="cstat-no" title="statement not covered" >[];</span>
        // for each key of the incidentsById object perform the check
<span class="cstat-no" title="statement not covered" >        for (let key in incidentsById) {</span>
            // perform the check
            const adjustedIncidents = <span class="cstat-no" title="statement not covered" >helper.systoleDiastoleProjections(incidentsById[key], durationFraction, adjustMillisecond);</span>
            const pluginResult = <span class="cstat-no" title="statement not covered" >this.instantiatedChannels[key].checkResizedIncidents(adjustedIncidents);</span>
<span class="cstat-no" title="statement not covered" >            toReturnResult = toReturnResult &amp;&amp; pluginResult.result;</span>
<span class="cstat-no" title="statement not covered" >            if (pluginResult.result === false) {</span>
<span class="cstat-no" title="statement not covered" >                toReturnErrors = toReturnErrors.concat(pluginResult.errors);</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                toReturnExecutables.push(pluginResult.execute);</span>
            }
        } // enf of iteration on the incidentsById keys
&nbsp;
        const toReturnExecute = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
<span class="cstat-no" title="statement not covered" >            for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; toReturnExecutables.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                toReturnExecutables[i]();</span>
            }
        }
&nbsp;
        const editResult = <span class="cstat-no" title="statement not covered" >{</span>
            result: toReturnResult,
            errors: toReturnErrors,
            execute: toReturnExecute
        }
<span class="cstat-no" title="statement not covered" >        return editResult;</span>
&nbsp;
    }
&nbsp;
&nbsp;
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    ge</span>tIncidentsByChannel(adjustMillisecond = <span class="branch-0 cbranch-no" title="branch not covered" >0)</span> {
        let incidentsByPlugin = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >        incidentsByPlugin[selfContainedIncidentsNpmName] = [{</span>
            millisecond: adjustMillisecond,
            incident: this,
            id: this.id
        }];
&nbsp;
<span class="cstat-no" title="statement not covered" >        return incidentsByPlugin;</span>
    }
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >    se</span>tVolume(newVal) {
<span class="cstat-no" title="statement not covered" >        this.volume = parseFloat(newVal);</span>
...
&nbsp;
     ...
     **/
<span class="fstat-no" title="function not covered" >    _o</span>nGetContextOnce(parentClipContext) {
<span class="cstat-no" title="statement not covered" >        return;</span>
    }
&nbsp;
&nbsp;
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    on</span>Progress(fraction, milliseconds, contextId, forceReset = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
<span class="cstat-no" title="statement not covered" >        if (this.contextReady === false) {</span>
<span class="cstat-no" title="statement not covered" >            this.setBlock();</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
<span class="cstat-no" title="statement not covered" >        if (!contextId) {</span>
<span class="cstat-no" title="statement not covered" >            contextId = this.id;</span>
        }
<span class="cstat-no" title="statement not covered" >        for (let key in this.instantiatedChannels) {</span>
            const channel = <span class="cstat-no" title="statement not covered" >this.instantiatedChannels[key];</span>
<span class="cstat-no" title="statement not covered" >            channel.moveTo(this.runTimeInfo.currentMillisecond, milliseconds, contextId, forceReset);</span>
        }
    }
&nbsp;
    flash() {
...
<span class="fstat-no" title="function not covered" >    su</span>bscribeToDurationChange(method) {
<span class="cstat-no" title="statement not covered" >        this.durationSubs.push(method);</span>
    }
&nbsp;
&nbsp;
    /********************************************************/
    /******** BLOCKING WAITINGS SET / REMOVE ***************/
<span class="fstat-no" title="function not covered" >    ha</span>ndleSetBlockingWaiting(target, payload) {
<span class="cstat-no" title="statement not covered" >        console.log('handling set blocking waiting');</span>
<span class="cstat-no" title="statement not covered" >        console.log(payload);</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    ha</span>ndleRemoveBlockingWaiting(target, payload) {
<span class="cstat-no" title="statement not covered" >        console.log('handling remove blocking waiting');</span>
<span class="cstat-no" title="statement not covered" >        console.log(payload);</span>
    }
&nbsp;
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Nov 01 2019 11:24:17 GMT+0000 (Coordinated Universal Time)
</div>
</div>
