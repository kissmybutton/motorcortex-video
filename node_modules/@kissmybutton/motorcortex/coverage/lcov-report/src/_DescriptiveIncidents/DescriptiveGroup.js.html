...
<html lang="en">
<head>
    <title>Code coverage report for src/_DescriptiveIncidents/DescriptiveGroup.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_DescriptiveIncidents</a> DescriptiveGroup.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">97.54% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>119/122</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L305'></a><a href='#L305'>305</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">14x</span>
...
&nbsp;
    constructor(attrs = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> props = null) {
        if (props === null) {
            super(attrs);
            this.attrs = {};
            this.props = attrs;
...
&nbsp;
    _rebuildTree() {
        ...
        for (let id in this.children) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (theChild.leaf.passive === true) {
