...
<html lang="en">
<head>
    <title>Code coverage report for src/_DescriptiveIncidents/DescriptiveClip.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_DescriptiveIncidents</a> DescriptiveClip.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.67% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>88/96</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L280'></a><a href='#L280'>280</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">12x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Playable = require('../_Clip/Playable');
...
const AudioClip = require('../_Audio/AudioClip');
const NullClip = require('../_Clip/NullClip');
&nbsp;
/**
...
&nbsp;
        // we initialise real and audio clips of the Clip by checking the audio
        // property
        let audio = propsToUse.audio;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!Object.prototype.hasOwnProperty(propsToUse, 'audio')) {
            audio = 'on';
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (audio === 'on' || <span class="branch-1 cbranch-no" title="branch not covered" >audio === 'off')</span> {
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (audio === 'on' || <span class="branch-1 cbranch-no" title="branch not covered" >audio === 'only')</span> {
            this.audioClip = new AudioClip({ audioSources: propsToUse.audioSources, runTimeInfo: this.runTimeInfo });
            if (this.isTheRootClip) {
                this.audioClip.subscribeToDurationChange(<span class="fstat-no" title="function not covered" >(n</span>ewDuration) =&gt; {
                    // TODO this.informForDurationChange();
                });
            }
        }
...
&nbsp;
<span class="fstat-no" title="function not covered" >    ha</span>ndleCheckEditAttributes(target, payload) { // eslint-disable-line no-unused-vars
<span class="cstat-no" title="statement not covered" >        return {</span>
            result: true
        }
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    ha</span>ndleCheckEditProperties(target, payload) { // eslint-disable-line no-unused-vars
<span class="cstat-no" title="statement not covered" >        return {</span>
            result: true
        }
    }
