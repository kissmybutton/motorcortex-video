...
<html lang="en">
<head>
    <title>Code coverage report for src/_responsiveness/ContextAwareClipIncident.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_responsiveness</a> ContextAwareClipIncident.js
    </h1>
    <div class='clearfix'>
...
<a name='L97'></a><a href='#L97'>97</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">11x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Leaf = require('../_Tree/Leaf');
const incidentFromIngredients = require('../IncidentFromDefinition/incidentFromIngredients');
const ClipCopy = require('../_Clip/ClipCopy');
...
&nbsp;
    onProgress(fraction, milliseconds, contextId, forceReset = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
...
&nbsp;
        ...
        const ingredientsToPass = { ...this.constructionIngredients, context: contextData.context, mcid: this.mcid, Incident: ClipCopy, dnaExtras: { descriptiveIncident: this.descriptiveIncident } };
