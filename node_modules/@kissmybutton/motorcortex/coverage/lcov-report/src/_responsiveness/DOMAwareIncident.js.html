...
<html lang="en">
<head>
    <title>Code coverage report for src/_responsiveness/DOMAwareIncident.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_responsiveness</a> DOMAwareIncident.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Group = require('../_BaseClasses/Group');
...
&nbsp;
        ...
        for (let i = 0; i &lt; elements.length; i++) {
            ...
            for (let contextKey in this.instantiatedCopiesContexts) {
<span class="cstat-no" title="statement not covered" >                this._setElementMCID(this.instantiatedCopiesContexts[contextKey], this.instantiatedCopiesContexts[contextKey][i], mcid);</span>
            }
