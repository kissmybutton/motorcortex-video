...
<html lang="en">
<head>
    <title>Code coverage report for src/_Clip/ExtendableClip.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_Clip</a> ExtendableClip.js
    </h1>
    <div class='clearfix'>
...
<a name='L595'></a><a href='#L595'>595</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">12x</span>
...
&nbsp;
     ...
     **/
    checkResize(durationFraction, incidentsById, adjustMillisecond = <span class="branch-0 cbranch-no" title="branch not covered" >0)</span> {
        // prepare the return payload
        let toReturnResult = true;
        let toReturnErrors = [];
        let toReturnExecutables = [];
...
<span class="cstat-no" title="statement not covered" >        return; </span>// Clips do not get context from noone
    }
&nbsp;
&nbsp;
