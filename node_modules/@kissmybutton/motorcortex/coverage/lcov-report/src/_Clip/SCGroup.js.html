...
<html lang="en">
<head>
    <title>Code coverage report for src/_Clip/SCGroup.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_Clip</a> SCGroup.js
    </h1>
    <div class='clearfix'>
...
<a name='L74'></a><a href='#L74'>74</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">12x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">12x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const conf = require('../configuration/generalConf');
&nbsp;
// context handlers
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (document.head.createShadowRoot || document.head.attachShadow) {
<span class="cstat-no" title="statement not covered" >            ContextHanlder = WebComponentContextHandler;</span>
        }
        else {
