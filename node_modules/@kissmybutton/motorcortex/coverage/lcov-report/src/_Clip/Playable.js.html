...
<html lang="en">
<head>
    <title>Code coverage report for src/_Clip/Playable.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_Clip</a> Playable.js
    </h1>
    <div class='clearfix'>
...
<a name='L213'></a><a href='#L213'>213</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">12x</span>
...
&nbsp;
     ...
     ****************************************************************/
    _setState(newState) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (newState != this.runTimeInfo.state) {
...
&nbsp;
    // execution methods
    play(debug = false) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.runTimeInfo.state === 'idle' || this.runTimeInfo.state === 'paused' || <span class="branch-2 cbranch-no" title="branch not covered" >this.runTimeInfo.state === 'transitional')</span> {
...
&nbsp;
            ...
            this.onPlay();
            if (debug === false) {
                window.requestAnimationFrame(<span class="fstat-no" title="function not covered" >(t</span>imestamp) =&gt; {
...
&nbsp;
    _onProgress(fraction, millisecond) {
...
&nbsp;
    // *******************************************************
    // STEP FUNCTION
    step(timestamp, debug = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
        if (this.runTimeInfo.state !== 'playing') {
            return;
        }
&nbsp;
...
&nbsp;
        if (progress.fraction &gt;= 1) {
            this._onProgress(1, this.duration);
            this.complete();
            return;
        }
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (progress.fraction &lt; 0) {
<span class="cstat-no" title="statement not covered" >            this._onProgress(0, 0);</span>
...
&nbsp;
        this._onProgress(progress.fraction, progress.milliseconds);
&nbsp;
        this.previousTimeStamp = timestamp;
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (debug === false) {
