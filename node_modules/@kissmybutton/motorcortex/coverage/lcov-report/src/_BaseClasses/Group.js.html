...
<html lang="en">
<head>
    <title>Code coverage report for src/_BaseClasses/Group.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/_BaseClasses</a> Group.js
    </h1>
    <div class='clearfix'>
...
<a name='L103'></a><a href='#L103'>103</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">16x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">16x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Node = require('../_Tree/Node');
...
&nbsp;
    handleAddIncident(target, payload) {
        if (this.id === target) {
            ...
            return incidentFromDescription(payload.incident, payload.contextData, payload.audio);
        }
        else {
            return this.bypass();
        }
