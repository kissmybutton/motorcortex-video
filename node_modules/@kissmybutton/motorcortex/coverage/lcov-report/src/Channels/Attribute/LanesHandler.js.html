...
<html lang="en">
<head>
    <title>Code coverage report for src/Channels/Attribute/LanesHandler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/Channels/Attribute</a> LanesHandler.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">86.08% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>167/194</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">76.74% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>66/86</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>158/182</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L478'></a><a href='#L478'>478</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const _filter = require('../../../lodash-custom-build/modularize/lodash.filter/index');
...
&nbsp;
class LanesHandler {
    constructor(props = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
        /*
...
<span class="fstat-no" title="function not covered" >    _r</span>esize(durationFraction) {
        const keys = <span class="cstat-no" title="statement not covered" >this.lanes._keys();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; keys.length; i++) {</span>
            const key = <span class="cstat-no" title="statement not covered" >keys[i];</span>
            const theLane = <span class="cstat-no" title="statement not covered" >this.lanes._get(key);</span>
<span class="cstat-no" title="statement not covered" >            for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; theLane.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                theLane[i].millisecond = theLane[i].millisecond * durationFraction;</span>
            }
        }
    }
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.comboAttributes) {
...
&nbsp;
    ...
    getOverlappingAnims(newAnim, mcid, attr, excludeIdsFromCheck = [], testDuration = null) {
        ...
        let overlappingAnims = _filter(this.lanes._get(helper.getLaneKey(mcid, attr)), function (existingAnim) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (testDuration != null) {
<span class="cstat-no" title="statement not covered" >                durationToUseOnChecks = testDuration;</span>
            }
&nbsp;
            return (
...
&nbsp;
        // indexing stuff
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.belongingLaneKeysByAnimationId._hasOwnProperty(incident.id)) {
...
&nbsp;
        ...
        if (newAnimsIndex + 1 &lt; theLane.length) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (this.incidentsById._get(theLane[newAnimsIndex + 1].id).gotContext) {
    ...
    updateLane(affectedAnimationsIds, millisecondsDelta) {
        ...
        for (let i = 0; i &lt; affectedAnimationsIds.length; i++) {
            ...
            for (let j = 0; j &lt; belongingLanes.length; j++) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (!Object.prototype.hasOwnProperty.call(affectedLanes, laneKey)) {
...
&nbsp;
                <span class="missing-if-branch" title="else path not taken" >E</span>if (animationIndexBeforeEdit !== animationIndexAfterEdit || <span class="branch-1 cbranch-no" title="branch not covered" >animationIndexAfterEdit &gt; 1)</span> {
                    if (animationIndexBeforeEdit + 1 &lt; lane.length) { // if the animation was not the last animation on the lane before the edit
                        ...
                        if (animationIndexBeforeEdit === 0) { // if the edited animation was the first one before the edit
                            ...
                            if (isComboAttr) {
                                const indexToAffect = animationIndexAfterEdit &gt; animationIndexBeforeEdit ? <span class="branch-0 cbranch-no" title="branch not covered" >animationIndexBeforeEdit </span>: animationIndexAfterEdit;
...
&nbsp;
                    ...
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (animationIndexAfterEdit + 1 &lt; lane.length) {
...
&nbsp;
                ...
                for (let k = 0; k &lt; lane.length; k++) {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (lane[k].id === id) {
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (lane.length === 0) {
...
<span class="cstat-no" title="statement not covered" >                    animationObjectToDelete.onProgress(0, 0);</span>
<span class="cstat-no" title="statement not covered" >                    this.lanes._delete(belongingLanes[j]);</span>
<span class="cstat-no" title="statement not covered" >                    if (Object.prototype.hasOwnProperty.call(affectedLanes, belongingLanes[j])) {</span>
<span class="cstat-no" title="statement not covered" >                        delete affectedLanes[belongingLanes[j]];</span>
                    }
                }
                else {
                    affectedLanes[belongingLanes[j]] = helper.getMCIDandAttrOutOfLaneKey(belongingLanes[j]);
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (animationIndexBeforeEdit &lt; lane.length &amp;&amp; this.incidentsById._get(animationToDelete.id).pureInitialValues !== false) {
...
<span class="cstat-no" title="statement not covered" >        for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; keys.length; i++) {</span>
            const key = <span class="cstat-no" title="statement not covered" >keys[i];</span>
            const theLane = <span class="cstat-no" title="statement not covered" >this.lanes._get(key);</span>
<span class="cstat-no" title="statement not covered" >            if (theLane.length &gt; 0) {</span>
                const firstIncident = <span class="cstat-no" title="statement not covered" >this.incidentsById._get(theLane[0].id);</span>
                const newScratchValue = <span class="cstat-no" title="statement not covered" >firstIncident.getScratchValue(contextId);</span>
                const laneData = <span class="cstat-no" title="statement not covered" >helper.getLaneDataFromLaneKey(key);</span>
<span class="cstat-no" title="statement not covered" >                if (Object.prototype.hasOwnProperty.call(this.comboAttributes, laneData.attribute)) { // if it is a combo</span>
<span class="cstat-no" title="statement not covered" >                    setInitialValueForCombo(theLane, this.incidentsById, newScratchValue, 0, true);</span>
                }
                else { // else if it's not a combo attribute
<span class="cstat-no" title="statement not covered" >                    firstIncident.setInitialValue(newScratchValue);</span>
                }
<span class="cstat-no" title="statement not covered" >                firstIncident.lastWish();</span>
<span class="cstat-no" title="statement not covered" >                firstIncident.onGetContext();</span>
            }
        }
    }
&nbsp;
