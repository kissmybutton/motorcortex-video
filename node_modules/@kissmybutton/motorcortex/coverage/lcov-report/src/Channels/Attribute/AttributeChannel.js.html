...
<html lang="en">
<head>
    <title>Code coverage report for src/Channels/Attribute/AttributeChannel.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/Channels/Attribute</a> AttributeChannel.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">60.34% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>105/174</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">60.12% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>98/163</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L553'></a><a href='#L553'>553</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Channel = require('../Channel');
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (props.comboAttributes != null) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    st</span>atic get type() {
<span class="cstat-no" title="statement not covered" >        return "attributes";</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    se</span>tComboAttributes(comboAttributes) {
<span class="cstat-no" title="statement not covered" >        this.comboAttributes = comboAttributes;</span>
<span class="cstat-no" title="statement not covered" >        this.LanesHandler = new lanesHandler({ comboAttributes: this.comboAttributes });</span>
    }
&nbsp;
    get lanes() {
...
<span class="cstat-no" title="statement not covered" >        this.LanesHandler._resize(durationFraction);</span>
    }
&nbsp;
&nbsp;
    /* *******************************************************
...
&nbsp;
            ...
            const attribute = incident.attribute || <span class="branch-1 cbranch-no" title="branch not covered" >this.fixedAttributeName;</span>
&nbsp;
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (overlappingAnims.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >                incidentConflicts = true;</span>
<span class="cstat-no" title="statement not covered" >                conflicts.push({</span>
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!incidentConflicts) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (conflicts.length &gt; 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >type === "all-or-nothing")</span> {
...
&nbsp;
        ...
        for (let i = 0; i &lt; incidents.length; i++) {
            ...
            const attribute = incidents[i].incident.attribute || <span class="branch-1 cbranch-no" title="branch not covered" >this.fixedAttributeName;</span>
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (conflicts.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >            return {</span>
                result: false,
                errors: conflicts
            }
...
&nbsp;
     ...
     **/
<span class="fstat-no" title="function not covered" >    ch</span>eckResizedIncidents(incidents, fullChannelResize = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
        const excludeIdsFromCheck = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >        for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; incidents.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >            excludeIdsFromCheck.push(incidents[i].id);</span>
        }
&nbsp;
        const LanesHandlerSandbox = <span class="cstat-no" title="statement not covered" >this.LanesHandler.createTestLanesSanbox();</span>
&nbsp;
        let conflicts = <span class="cstat-no" title="statement not covered" >[];</span>
        let affectedLanes = <span class="cstat-no" title="statement not covered" >[];</span>
&nbsp;
        // for each of the incidents passed
<span class="cstat-no" title="statement not covered" >        for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; incidents.length; i++) {</span>
            // get the ContextAwareIncident
            const incident = <span class="cstat-no" title="statement not covered" >this.LanesHandler.incidentsById._get(incidents[i].id);</span>
            const mcid = <span class="cstat-no" title="statement not covered" >incident.mcid;</span>
            const attribute = <span class="cstat-no" title="statement not covered" >incident.attribute || this.fixedAttributeName;</span>
&nbsp;
            const lane = <span class="cstat-no" title="statement not covered" >LanesHandlerSandbox.getLane(mcid, attribute);</span>
            const laneAttrs = <span class="cstat-no" title="statement not covered" >{</span>
                mcid: mcid,
                attribute: attribute
            }
&nbsp;
            const testDuration = <span class="cstat-no" title="statement not covered" >incidents[i].end - incidents[i].start;</span>
&nbsp;
            // check for conflicts and edit lane items millisecond
<span class="cstat-no" title="statement not covered" >            for (let k = <span class="cstat-no" title="statement not covered" >0;</span> k &lt; lane.length; k++) {</span>
<span class="cstat-no" title="statement not covered" >                if (lane[k].id === incidents[i].id) {</span>
<span class="cstat-no" title="statement not covered" >                    affectedLanes.push(laneAttrs);</span>
<span class="cstat-no" title="statement not covered" >                    if (fullChannelResize === false) {</span>
                        let affectedAnim = <span class="cstat-no" title="statement not covered" >lane[k];</span>
                        let testLaneElement = <span class="cstat-no" title="statement not covered" >LanesHandlerSandbox.getLaneElementsClone(affectedAnim);</span>
<span class="cstat-no" title="statement not covered" >                        testLaneElement.millisecond += incidents[i].startDelta;</span>
<span class="cstat-no" title="statement not covered" >                        testLaneElement.incident = LanesHandlerSandbox.incidentsById._get(testLaneElement.id);</span>
                        let overlappingAnims = <span class="cstat-no" title="statement not covered" >LanesHandlerSandbox.getOverlappingAnims(testLaneElement, laneAttrs.mcid, laneAttrs.attribute, excludeIdsFromCheck, testDuration);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                        if (overlappingAnims.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                            conflicts.push({</span>
                                type: 'anauthorised overlapping animations on the same element',
                                meta: {
...
&nbsp;
            const exec = <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction () {</span>
                ...
                // success message
<span class="cstat-no" title="statement not covered" >                for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; incidents.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                    that.LanesHandler.updateLane([incidents[i].id], incidents[i].startDelta);</span>
                }
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            return {</span>
...
&nbsp;
     ...
     *
     */
    checkDelete(removedAnimations, props = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> { // eslint-disable-line no-unused-vars
...
&nbsp;
     ...
     * context id
     **/
<span class="fstat-no" title="function not covered" >    re</span>calcScratchValues(contextId) {
<span class="cstat-no" title="statement not covered" >        this.LanesHandler.recalcScratchValues(contextId);</span>
    }
&nbsp;
    /**
     ...
     */
    slipIntoLaneForwards(lane, laneData, currentMillisecond, millisecond, contextId, forceReset = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
...
&nbsp;
        if (participatingAnims.length == 0) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (forceReset === true) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (participatingAnim.duration + startMillisecond &lt;= millisecond) {
            // and it's the last one on the row
<span class="cstat-no" title="statement not covered" >            participatingAnim.onProgress(1, participatingAnim.duration, contextId);</span>
        }
        else {
...
&nbsp;
     ...
     * @param {string} contextId - the contextId of the Incidents to slip
     */
<span class="fstat-no" title="function not covered" >    sl</span>ipToLaneBackwards(lane, laneData, currentMillisecond, millisecond, contextId, forceReset = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
        // we take all Animations that are either currently running or
        // they end after the destination point
        // helper.log('&lt;------');
        const that = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
        let participatingAnims = <span class="cstat-no" title="statement not covered" >_filter(lane, <span class="fstat-no" title="function not covered" >la</span>neItem =&gt; {</span>
            const laneItemEnd = <span class="cstat-no" title="statement not covered" >that.incidentsById._get(laneItem.id).duration + laneItem.millisecond;</span>
<span class="cstat-no" title="statement not covered" >            return (</span>
...
&nbsp;
        ...
        // });
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (participatingAnims.length == 0) {</span>
<span class="cstat-no" title="statement not covered" >            if (participatingAnims.length == 0) {</span>
<span class="cstat-no" title="statement not covered" >                if (forceReset === true) {</span>
                    const firstIncident = <span class="cstat-no" title="statement not covered" >this.incidentsById._get(lane[lane.length - 1].id);</span>
<span class="cstat-no" title="statement not covered" >                    firstIncident.onProgress(1, firstIncident.duration, contextId)</span>
                }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        participatingAnims = _sortBy(participatingAnims, [</span>
<span class="fstat-no" title="function not covered" >            la</span>neItem =&gt; {
<span class="cstat-no" title="statement not covered" >                return laneItem.millisecond;</span>
            }
        ]);
&nbsp;
        // We only care about the first (in chronological order) Incident, as this
        // will define the final value of the backwards move
        const lastIndex = <span class="cstat-no" title="statement not covered" >0;</span>
        const participatingAnim = <span class="cstat-no" title="statement not covered" >this.incidentsById._get(participatingAnims[lastIndex].id);</span>
        const startMillisecond = <span class="cstat-no" title="statement not covered" >participatingAnims[lastIndex].millisecond;</span>
&nbsp;
        // if the animation starts after the target millisecond
<span class="cstat-no" title="statement not covered" >        if (startMillisecond &gt;= millisecond) {</span>
<span class="cstat-no" title="statement not covered" >            participatingAnim.onProgress(0, 0, contextId);</span>
        }
        else {
            // slip for the specific element and the specific attribute. Set the Animation as paused or playing a
            // and store this info somewhere
            const percentageComplete =
<span class="cstat-no" title="statement not covered" >                (millisecond - startMillisecond) / participatingAnim.duration;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            participatingAnim.onProgress(percentageComplete, millisecond - startMillisecond, contextId);</span>
        }
    }
&nbsp;
    /**
     ...
     */
    moveTo(from, to, contextId, forceReset = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
        ...
        for (let i = 0; i &lt; laneKeys.length; i++) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (from &lt;= to) {
            ...
            else <span class="cstat-no" title="statement not covered" >if (from &gt; to) {</span>
<span class="cstat-no" title="statement not covered" >                this.slipToLaneBackwards(</span>
                    lane,
                    laneData,
                    from,
                    to,
