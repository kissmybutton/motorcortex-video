...
<html lang="en">
<head>
    <title>Code coverage report for src/Channels/Channel.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/Channels</a> Channel.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        return "plain";</span>
    }
&nbsp;
    onInitialise() {}
&nbsp;
<span class="fstat-no" title="function not covered" >    _r</span>esize() {
<span class="cstat-no" title="statement not covered" >        helper.log('Please overwite the _resize method of the Channel');</span>
    }
&nbsp;
    /**
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (result.result === false) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    ch</span>eckResizedIncidents(incidents) { // eslint-disable-line no-unused-vars
<span class="cstat-no" title="statement not covered" >        return { result: true, execute: <span class="fstat-no" title="function not covered" >fu</span>nction () {} };</span>
    }
&nbsp;
