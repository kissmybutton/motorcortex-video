...
<html lang="en">
<head>
    <title>Code coverage report for tester/Tester.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">tester</a> Tester.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>20/36</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class Tester {
    /**
    ...
    testTree(expected, actual) {
        let errors = [];
        <span class="missing-if-branch" title="if path not taken" >I</span>if (expected.id !== actual.id) {
...
&nbsp;
        if (expected.hasOwnProperty('duration')) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (expected.duration !== actual.duration) {
<span class="cstat-no" title="statement not covered" >                errors.push({</span>
...
&nbsp;
        ...
        if (expected.hasOwnProperty('children')) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.keys(expected.children).length !== Object.keys(actual.children).length) {
<span class="cstat-no" title="statement not covered" >                errors.push({</span>
...
&nbsp;
            for (let key in expected.children) {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!actual.children.hasOwnProperty(key)) {
<span class="cstat-no" title="statement not covered" >                    errors.push({</span>
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (expected.children[key].position !== actual.children[key].position) {
<span class="cstat-no" title="statement not covered" >                        errors.push({</span>
...
&nbsp;
    ...
    testLanes(expected, actual, incidentsById) {
        ...
        let errors = [];
        <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.keys(expected).length !== Object.keys(actual).length) {
<span class="cstat-no" title="statement not covered" >            errors.push({</span>
...
&nbsp;
        for (let laneKey in expected) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!actual.hasOwnProperty(laneKey)) {
<span class="cstat-no" title="statement not covered" >                errors.push({</span>
            ...
            else <span class="missing-if-branch" title="if path not taken" >I</span>if (expected[laneKey].length !== actual[laneKey].length) {
<span class="cstat-no" title="statement not covered" >                errors.push({</span>
...
&nbsp;
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!incidentsById.realArray.hasOwnProperty(expectedLaneItem.id)) {
<span class="cstat-no" title="statement not covered" >                        errors.push({</span>
...
<span class="cstat-no" title="statement not covered" >                        incidentPresent = false;</span>
                    }
&nbsp;
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (expectedLaneItem.millisecond !== actualLaneItem.millisecond) {
<span class="cstat-no" title="statement not covered" >                        errors.push({</span>
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (expectedLaneItem.id !== actualLaneItem.id) {
<span class="cstat-no" title="statement not covered" >                        errors.push({</span>
                    ...
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (incidentPresent) {
                        ...
                        try {
                            <span class="missing-if-branch" title="if path not taken" >I</span>if (expectedLaneItem.initialValue !== incident.getInitialValue()) {
<span class="cstat-no" title="statement not covered" >                                errors.push({</span>
                                    type: `LANES: initial value missmatch`,
                                    expected: expectedLaneItem.initialValue,
                                    actual: incident.getInitialValue(),
                                    expectedObject: expectedLaneItem,
                                    actualObject: actualLaneItem
                                });
                            }
...
<span class="cstat-no" title="statement not covered" >                            console.log(e);</span>
                            ...
                            // console.log(incident.constructor);
                            // console.log(incident.getInitialValue);
                        }
                    }
                }
            }
...
&nbsp;
        for (let i = 0; i &lt; expected.length; i++) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (expected[i].id !== actual[i].id) {
<span class="cstat-no" title="statement not covered" >                errors.push({</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (expected[i].millisecond !== actual[i].millisecond) {
<span class="cstat-no" title="statement not covered" >                errors.push({</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Sep 05 2019 12:05:38 GMT+0000 (Coordinated Universal Time)
</div>
</div>
