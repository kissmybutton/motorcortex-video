...
<html lang="en">
<head>
    <title>Code coverage report for _Tree/Node.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">_Tree</a> Node.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3x</span></td><td class="text"><pre class="prettyprint lang-js">const Leaf = require('./Leaf');
    ...
    constructor(props={}) {
        ...
        /**
          The array holds the Incidents of the Scene on the format:
          {
                ...
                position // the millisecond the incident should be executed
          }
           */
        this.children = [];
&nbsp;
        /*
        an object / associative array holding all Leafs in the form:
        &lt;leaf_id&gt;: Leaf object
         */
        this.childrenById = {};
    }
    ...
    getLeafById(id) {
        if(this.childrenById.hasOwnProperty(id)){
            return this.childrenById[id];
        } else {
            for(let i=0; i&lt;this.children.length; i++){
                <span class="missing-if-branch" title="else path not taken" >E</span>if(this.children[i].leaf.isNode){
                    let leaf = this.children[i].leaf.getLeafById(id);
...
<span class="cstat-no" title="statement not covered" >        return null;</span>
    ...
    addChild(leaf, position, options={}) {
...
<span class="cstat-no" title="statement not covered" >            return {</span>
        ...
        this.childrenById[leaf.id] = leaf;
        this.children.push({
            id: leaf.id,
            leaf: leaf,
            position: position
    ...
    removeChild(id) {
        this.childrenById[id] = null;
        for (let i = 0; i &lt; this.children.length; i++) {
            if (this.children[i].id === id) {
                const deletedLeaf= this.children.splice(i, 1);
                deletedLeaf[0].leaf.detachFromParent();
                return {
                    result: true
                };
            }
    ...
    editPosition(id, position) {
        ...
        for(let i=0; i&lt;this.children.length; i++) {
            if(this.children[i].id === id) {
                this.children[i].position = position;
                return {
                    result: true
                }
            }
    ...
    */
    putMessageOnPipe(name, payload, target, options=<span class="branch-0 cbranch-no" title="branch not covered" >{})</span>{
        if(options.direction === _CONST._DIRECTIONS._UP) { // if the direction is up 
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if(result.length &gt; 0) {
<span class="cstat-no" title="statement not covered" >                return result;</span>
            }
            
            let newOptions = Object.assign({}, options);
            newOptions.selfExecute = true;
            for(let i=0; i&lt;this.children.length; i++) {
                result = result.concat(this.children[i].leaf.putMessageOnPipe(name, payload, target, newOptions));
            }
